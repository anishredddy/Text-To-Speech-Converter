...
rootmain = Tk()
rootmain.geometry('450x400')
rootmain.resizable(True,True)
rootmain.config(bg = 'lavender')
rootmain.title('EE - TEXT_TO_SPEECH')

Label(rootmain, text ='WELCOME TO TEXT TO SPEECH CONVERTER', font ='arial 21 bold', bg ='white smoke').place(x=180,y=60)

## inputing choice from user

Label(rootmain, text ='1.enter your text on window', font ='arial 15 bold', bg ='white smoke').place(x=20,y=200)
Label(rootmain, text ='2.enter file name to be read', font ='arial 15 bold', bg ='white smoke').place(x=20,y=300)
Choice = StringVar()
...
def Enter():
    ...
    if choice=='1':
        ...
        root.title('EE - TEXT_TO_SPEECH')
        
        Label(root, text = 'TEXT_TO_SPEECH' , font='arial 20 bold' , bg ='white smoke').pack()
        Label(root, text ='EE' , font ='arial 15 bold', bg = 'white smoke').pack(side = BOTTOM)
        ...
        #button app
        Label(root, text ='Click on play button to hear entered text ', font ='arial 15 bold', bg ='misty rose').place(x=20,y=200)
        ...
        Label(root, text = 'TEXT_TO_SPEECH' , font='arial 20 bold').pack()
        Label(root, text ='EE' , font ='arial 15 bold', bg = 'misty rose').pack(side = BOTTOM)
        ...
        def Text_to_speech():
            ...
            speech.save('EE.mp3')
            #playsound('EE.mp3')
            os.system('start EE.mp3')
            time.sleep(10)
            os.system('close EE.mp3')
